...
- 它是 [[Euler-Lagrange 方程]] 从有限自由度到连续场的推广；
- [[经典场论]] 提供场和 Lagrangian 密度的语言；
- [[Stokes 定理]] 负责把总散度体积分转换为边界积分；
- [[能动张量]] 可由时空平移对称性或度量变分得到；
- [[Polyakov 作用量]] 对 $X^\mu$ 的变分产生二维波动方程，对世界面度量的变分产生约束。
