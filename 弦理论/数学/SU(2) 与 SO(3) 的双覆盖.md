...
- [[弦理论/数学/SU 群]] 给出 $SU(2)$ 的矩阵、中心和表示；
- [[弦理论/数学/SO 群]] 给出三维旋转群 $SO(3)$；
- [[弦理论/数学/Lie 群与 Lie 代数的对应]] 解释相同局部代数为何可对应不同全局群；
- [[弦理论/数学/群表示]] 区分整数与半整数自旋表示是否能下降到 $SO(3)$；
- [[弦理论/数学/Clifford 代数]] 用于构造一般 $Spin(n)$；
- [[弦理论/数学/Gamma 矩阵]] 是 Clifford 代数的矩阵表示；
- [[弦理论/数学/旋量]] 是 Spin 群的表示对象；
- [[弦理论/物理学/自旋]] 使用 $SU(2)$ 的不可约表示分类三维旋转下的量子态；
- [[弦理论/物理学/角动量]] 提供旋转生成元及其对易关系。
