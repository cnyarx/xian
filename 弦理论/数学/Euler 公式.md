...
这里的推导依赖无穷级数的收敛性，后续会在 [[弦理论/数学/级数]] 中系统说明。
...
- 公式由 [[弦理论/数学/指数函数]]、[[弦理论/数学/三角函数]] 和 [[弦理论/数学/复数]] 汇合而成；
- [[弦理论/物理学/简谐振动]] 和 [[弦理论/物理学/行波]] 可用复指数简写；
- [[弦理论/数学/Fourier 级数]] 用不同频率的复指数分解周期函数；
- [[弦理论/物理学/弦的模展开]] 本质上也使用许多不同频率的振动模式。
