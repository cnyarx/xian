...
[[弦理论/物理学/规范固定]] 会产生 [[弦理论/物理学/Faddeev-Popov 行列式]]。可用 Grassmann 奇标量场 $c,\bar c$ 表示该行列式：
...
- [[弦理论/物理学/二维自由费米子]] 用 Grassmann 奇场、换序负号和一阶动力学算符构造二维自由 CFT；
- [[弦理论/物理学/Faddeev-Popov 鬼场]] 用 Grassmann 场表示规范固定行列式；
