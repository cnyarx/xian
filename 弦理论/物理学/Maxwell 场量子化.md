...
与 $A_\mu$ 无关。因此 Maxwell 理论的 [[弦理论/物理学/Faddeev-Popov 行列式]] 只贡献一个与场无关的常数；相应鬼场是自由的并从普通散射振幅中解耦。
...
- [[弦理论/物理学/Maxwell 方程]] 给出经典场方程、Gauss 定律和电磁波；
- [[弦理论/物理学/规范对称性]] 解释四维势的冗余和规范轨道；
- [[弦理论/物理学/经典场论]] 与 [[弦理论/物理学/Minkowski 时空]] 提供作用量和 Lorentz 协变框架；
- [[弦理论/物理学/量子算符]]、[[弦理论/物理学/对易关系]] 与 [[弦理论/物理学/Fock 空间]] 构造光子态；
- [[弦理论/数学/Fourier 变换]] 将自由 Maxwell 方程分解为动量和偏振模式；
- [[弦理论/物理学/光子]] 是量子化 Maxwell 场的单量子激发；
- [[弦理论/物理学/场的正则量子化]] 系统处理场、共轭动量和约束；
- [[弦理论/物理学/传播子]] 给出规范固定后的电磁传播核；
- [[弦理论/物理学/规范固定]]、[[弦理论/物理学/Faddeev-Popov 鬼场]] 与 [[弦理论/物理学/BRST 对称性]] 给出协变量子化语言；
- [[弦理论/物理学/Yang-Mills 理论]] 把 Abelian Maxwell 规范场推广到非交换群；
- [[弦理论/物理学/Wilson 线与 Wilson 圈]] 说明紧致空间中的 Wilson 线和磁通自由度不包含在局部平面波计数中，并展示全局 holonomy 如何探测 Maxwell 场量子化未能直接看到的拓扑信息；
- [[弦理论/物理学/开弦质量谱]] 的无质量矢量态在低能极限产生规范场。
