...
[[弦理论/物理学/规范固定]] 解释了为什么需要选择规范切片，并给出了插入恒等式的思想。但未回答以下问题：
...
本页完成这些推导，把 FP 算符和行列式建立为可独立使用的对象。下一页 [[弦理论/物理学/Faddeev-Popov 鬼场]] 用 Grassmann 场把这个行列式指数化并写出鬼作用量。
...
本页只说明这些边界；鬼作用量的完整符号固定见 [[弦理论/物理学/Faddeev-Popov 鬼场]]。
...
- [[弦理论/物理学/规范固定]] 是本页的直接前驱，给出规范轨道、切片和插入恒等式的思想；
- [[弦理论/物理学/路径积分]] 提供泛函测度、变量变换和 Gaussian 行列式背景；
- [[弦理论/物理学/Yang-Mills 理论]] 给出 non-Abelian 规范场的作用量和约定；
- [[弦理论/数学/群作用]] 解释轨道、稳定子、商空间和群作用分层；
- [[弦理论/物理学/圈展开]] 在 non-Abelian 一圈计算中需要 FP 行列式及 [[弦理论/物理学/Faddeev-Popov 鬼场]] 的贡献；
- [[弦理论/弦理论完整学习路线图]] 将本节点放在规范固定与 [[弦理论/物理学/Faddeev-Popov 鬼场]] 之间。
