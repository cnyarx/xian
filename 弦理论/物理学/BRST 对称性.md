...
- 上一页：[[弦理论/物理学/Faddeev-Popov 鬼场]]
- 下一页：[[弦理论/物理学/BRST 上同调]]
- 总路线：[[弦理论/弦理论完整学习路线图]]
...
[[弦理论/物理学/规范固定]] 消除了路径积分对规范轨道的重复计数，[[弦理论/物理学/Faddeev-Popov 鬼场]] 又把功能行列式改写成局域作用量。但规范固定后的拉氏量不再显式保持原来的局域规范不变性，因此还需要一种新的对称结构回答：
...
BRST 对称性给出的核心工具是幂零微分 $s$。下一页 [[弦理论/物理学/BRST 上同调]] 将研究 $s$ 或 $Q$ 的闭对象模去恰当对象，本页先建立这一代数结构和作用量实现。
...
成正比，因此由 [[弦理论/数学/Lie 代数]] 的 Jacobi 恒等式得到
...
BRST 变换的参数 $\varepsilon$ 是时空常数，因此它是一种全局连续对称性。由 [[弦理论/物理学/Noether 定理]] 可构造守恒流
...
这一商空间的系统计算、闭态与恰当态的分类，以及 quartet mechanism 见下一节点 [[弦理论/物理学/BRST 上同调]]。
...
在 Hamilton 约束系统中，一阶约束的括号代数编码规范变换闭合。[[弦理论/物理学/Poisson 括号]] 提供经典括号结构，BRST 方法则扩展相空间、加入鬼变量，并把约束和结构常数组织进一个幂零荷。
...
本页只给出反常会破坏 Slavnov-Taylor 恒等式和量子 BRST 幂零性的入口。[[弦理论/物理学/量子反常]] 给出总框架；手征反常、Weyl 反常和反常消除属于后续独立节点。
...
- [[弦理论/物理学/Faddeev-Popov 鬼场]] 提供 $c,\bar c$、鬼作用量和 ghost number 的直接前驱；
- [[弦理论/物理学/规范固定]] 给出 $G[A]$、规范参数 $\xi$ 和规范切片；
- [[弦理论/物理学/Yang-Mills 理论]] 给出规范代数、场强和协变导数；
- [[弦理论/数学/Grassmann 变量]] 提供奇导子、分次 Leibniz 法则和 Berezin 积分；
- [[弦理论/数学/Lie 代数]] 的 Jacobi 恒等式保证 non-Abelian BRST 幂零性；
- [[弦理论/物理学/Noether 定理]] 把全局 BRST 对称性对应到守恒荷 $Q$；
- [[弦理论/物理学/Poisson 括号]] 是 Hamilton/BFV-BRST 约束代数的经典前驱；
- [[弦理论/数学/群作用]] 从轨道与商空间角度解释 BRST 所处理的冗余；
- [[弦理论/数学/模空间]] 在世界面规范固定中使用 BRST 和鬼场处理测度；
- [[弦理论/物理学/量子反常]] 说明测度或正规化如何破坏量子 Slavnov–Taylor 恒等式，以及何时该破缺不能由局域反项恢复；
- [[弦理论/物理学/Weyl 反常]] 说明世界面总中心荷和正规序条件怎样进入量子 BRST 荷的幂零性；
- [[弦理论/弦理论完整学习路线图]] 将本节点放在 FP 鬼场与 BRST 上同调之间。
