...
[[弦理论/物理学/Maxwell 方程|Maxwell 理论]] 描述 $U(1)$ 规范场，即光子。但自然界还有弱相互作用和强相互作用，它们分别由 $SU(2)$ 和 $SU(3)$ 规范群描述。Yang-Mills 理论提供统一的数学框架：
...
路线图下一节点 [[弦理论/物理学/规范协变导数]] 详细展开不同表示中的协变导数、Leibniz 法则和与联络的关系。
...
规范冗余不是物理对称性，而是描述中的多余自由度。[[弦理论/物理学/规范固定]] 展开如何选择规范条件和处理冗余；Elitzur 定理通过局域规范对称性无法自发破缺这一事实制约了“物理对称性”的日常语言，但完备的量子化还需要 [[弦理论/物理学/Faddeev-Popov 行列式]] 和后续 BRST 对称性一并建立。
...
1. **[[弦理论/物理学/规范固定]]**：选择规范条件 $G(A) = 0$ 处理冗余；
2. **[[弦理论/物理学/Faddeev-Popov 行列式]]**：把规范固定的 Jacobian 写入路径积分；
3. **[[弦理论/物理学/Faddeev-Popov 鬼场]]**：用 Grassmann 奇的标量场 $c^a, \bar{c}^a$ 表示行列式；
4. **[[弦理论/物理学/BRST 对称性]]**：用幂零 BRST 微分组织规范固定作用量、鬼场和物理态条件。

这四个页面已经建立；[[弦理论/物理学/BRST 上同调]] 进一步把物理态定义为闭态模去恰当态。
...
- [[弦理论/物理学/经典场论]] 提供作用量和场变分的基础；
- [[弦理论/物理学/Maxwell 方程]] 是 Abelian $U(1)$ 规范理论的原型；
- [[弦理论/物理学/规范对称性]] 解释规范冗余和局域变换的概念；
- [[弦理论/数学/Lie 群]] 提供有限规范变换所在的群；
- [[弦理论/数学/Lie 代数]] 提供生成元、结构常数和伴随表示；
- [[弦理论/数学/群表示]] 区分物质场和规范场的表示；
- [[弦理论/物理学/Maxwell 场量子化]] 建立 Abelian 规范场的量子化，并预告非 Abelian 鬼不解耦；
- [[弦理论/物理学/有效场论]] 是路线图的上一节点，Yang-Mills 是其低能极限的具体实现；
- [[弦理论/物理学/beta 函数]] 给出非 Abelian 规范理论的一圈 beta 函数和渐近自由条件；
- [[弦理论/数学/曲率]] 说明规范场强严格就是规范联络的曲率；
- [[弦理论/物理学/Wilson 线与 Wilson 圈]] 把局部规范联络沿有限路径积分为平行输运，并探测 holonomy、全局群结构和非微扰动力学；
- [[弦理论/弦理论完整学习路线图]] 将本节点放在有效场论之后、规范协变导数之前。
